...
public class GameView extends View {
	...
	public GameView(UserController userController) {
		...
		// userController.notifyModel(Controller.LOG_IN, new String[] {"Naam",
		// "localhost"});
		// userController.notifyModel(Controller.START_ONLINE_GAME, new String[]
		// {"reversi"});
		// userController.notifyModel(Controller.CHALLENGE_PLAYER, new String[] {"Naam",
		// "reversi"});
